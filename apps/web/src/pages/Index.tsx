          ...
          <div className="max-w-2xl space-y-6 animate-fade-in">
            ...
            <div className="flex gap-4">
              <Button
                size="lg"
                onClick={() => handleWatch()}
                className={enabled ? "bg-secondary text-secondary-foreground hover:bg-secondary/80" : "bg-primary hover:bg-primary/90"}
              >
            ...
            <div className="flex gap-2 flex-wrap">
              <span className="px-3 py-1 rounded-full text-sm bg-violence/20 text-violence border border-violence/30">Contains Violence</span>
              <span className="px-3 py-1 rounded-full text-sm bg-blood/20 text-blood border border-blood/30">Contains Blood</span>
            </div>
          </div>
        </div>
      </section>
